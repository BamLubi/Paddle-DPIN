...
class DygraphModel():
    ...
    def create_feeds(self, batch, config):
        ...
        position = batch[8]
        return hist_item_seq, hist_cat_seq, target_item, target_cat, label, mask, target_item_seq, target_cat_seq, position
    ...
    def train_forward(self, dy_model, metrics_list, batch_data, config):
        hist_item_seq, hist_cat_seq, target_item, target_cat, label, mask, target_item_seq, target_cat_seq, position = self.create_feeds(
            batch_data, config)
        ...
        metrics_list[1].update(preds=predict_2d.numpy(), labels=label_int.numpy(), position=position, K=3)
