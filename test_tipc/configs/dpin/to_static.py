...
def main(args):
    ...
    L = config.get("hyper_parameters.L", 10)
    ...
    dy_model = paddle.jit.to_static(
        dy_model,
        input_spec=[
            paddle.static.InputSpec(shape=[None, K, L], dtype='int32',name='hist_item'),
            paddle.static.InputSpec(shape=[None, K, L], dtype='int32',name='hist_cat'), 
            paddle.static.InputSpec(shape=[None], dtype='int32', name='target_item'),
            paddle.static.InputSpec(shape=[None], dtype='int32', name='target_cat'),
            paddle.static.InputSpec(shape=[None, K], dtype='int32', name='position')
        ])
